...
class Auxiliar:
    def __init__(self):
        ...
        ############################################### '''
        self.data = '25 30 35 20 90 110 45 70 80 12 30 35 85'
        self.resps = [335, ]

    def printFn(self, *query,**kwargs):
        ''' Mock of print function
        ############################################### '''
        print('printed:', query, kwargs)

    def inputGen(self):
        ''' Mock of input
        ############################################### '''
        print('input:', self.data)
        print('input:', self.resps)
        yield self.data
...
class Pruebas(unittest.TestCase):
    ...
    @patch('petrolpump_v0.print', create=True) # al mockear se debe poner la ruta completa.
    @patch('petrolpump_v0.input', create=True)
